...
#define ECAT_TIMER_INC_P_MS                1000 //72000   	//0x271 /**< \brief 625 ticks per ms*/
...
#ifndef HW_GetTimer
#define HW_GetTimer()       		TIM3->CNT		//(SysTick->LOAD - 	SysTick->VAL) //			// ((UINT16)(TMR7)) /**< \brief Access to the hardware timer*/
#endif

#ifndef HW_ClearTimer
#define HW_ClearTimer()         ((TIM3->CNT)=0); //(SysTick->VAL = SysTick->LOAD)// //{(TMR7) = 0;} /**< \brief Clear the hardware timer*/
#endif
