...
typedef struct STRUCT_PACKED_START
{
	...
	INT32 ObTorqueActualValue; /**< \brief Actual position (0x6077)*/
	INT16 ObjModesOfOperationDisplay; /**< \brief Current mode of operation (0x6061)*/
}STRUCT_PACKED_END
TCiA402PDO1A01;
...
typedef struct STRUCT_PACKED_START
{
    UINT16 ObjControlWord; /**< \brief Control word (0x6040)*/
    INT32 ObjTargetPosition; /**< \brief Target position (0x607A)*/
	INT32 ObjTargetTorque; /**< \brief Target position (0x608A)*/
	INT32 ObjTargetKp; /**< \brief Target position (0x6096)*/
	INT32 ObjTargetKd; /**< \brief Target position (0x6098)*/
	INT32 ObjTargetVelocity; /**< \brief Target velocity (0x60FF)*/
	INT16 ObjModesOfOperation; /**< \brief Mode of operation (0x6060)*/
}STRUCT_PACKED_END
TCiA402PDO1601;
...
typedef struct OBJ_STRUCT_PACKED_START
{
    ...
    INT32 objTorqueActualValue; /**< \brief Torque Actual Value (0x6077)*/
    INT32 objTargetPosition; /**< \brief Target Position (0x607A)*/
	...
	INT32 objTargetTorque; /**< \brief Target Torque (0x608A)*/
	INT32 objTargetKp; /**< \brief Target Torque (0x6096)*/
	INT32 objTargetKd; /**< \brief Target Torque (0x6098)*/
...
/** \brief Data structure to handle an Cia402 axis  cia402轴的数据结构*/
typedef struct
{
    BOOL        bAxisIsActive; /**< \brief Indicates if active is active是否激活*/
    BOOL        bBrakeApplied; /**< \brief Motor break is applied 电机中断*/
    BOOL        bLowLevelPowerApplied; /**< \brief Low Level Power applied是否低电*/
    BOOL        bHighLevelPowerApplied; /**< \brief High Level Power applied是否最大电压*/
    BOOL        bAxisFunctionEnabled; /**< \brief Axis functions enabled  轴功能使能*/
    BOOL        bConfigurationAllowed; /**< \brief Configuration allowed   参数允许*/

    UINT16      i16State; /**< \brief Axis state   轴状态*/
    UINT16      u16PendingOptionCode; /**< \brief Pending operation code   等待*/
    double      fCurPosition; /**< \brief Current position within control loop  当前位置*/
    UINT32      u32CycleTime; /**< \brief Motion controller cycletime in us   控制周期*/


    CiA402Objects        Objects; /**< \brief CiA402 Axis object variable  对象变量*/
    TOBJECT OBJMEM        * ObjDic; /**< \brief Pointer to Axis specific object dictionary指定轴的特定对象字典*/
}
...
OBJCONST TSDOINFOENTRYDESC    OBJMEM sEntryDesc0x6077 = {DEFTYPE_INTEGER32, 0x20, (ACCESS_READ|OBJACCESS_TXPDOMAPPING)};
...
/** \brief Object 0x607A (Target Position) entry description*/
OBJCONST TSDOINFOENTRYDESC    OBJMEM sEntryDesc0x608A = {DEFTYPE_INTEGER32, 0x20, (ACCESS_READWRITE|OBJACCESS_RXPDOMAPPING)};

/** \brief Object 0x607A (Target Position) object name*/
OBJCONST UCHAR OBJMEM aName0x608A[] = "Target Torque";
/** \brief Object 0x6096 (Target Position) entry description*/
OBJCONST TSDOINFOENTRYDESC    OBJMEM sEntryDesc0x6096 = {DEFTYPE_INTEGER32, 0x20, (ACCESS_READWRITE|OBJACCESS_RXPDOMAPPING)};

/** \brief Object 0x607A (Target Position) object name*/
OBJCONST UCHAR OBJMEM aName0x6096[] = "Target Kp";

/** \brief Object 0x6096 (Target Position) entry description*/
OBJCONST TSDOINFOENTRYDESC    OBJMEM sEntryDesc0x6098 = {DEFTYPE_INTEGER32, 0x20, (ACCESS_READWRITE|OBJACCESS_RXPDOMAPPING)};

/** \brief Object 0x607A (Target Position) object name*/
OBJCONST UCHAR OBJMEM aName0x6098[] = "Target Kd";
...
/*ECATCHANGE_END(V5.11) CiA402 1*/
{8, {0x60400010,0x60600008,0x607A0020,0x608A0020,0x60960020,0x60980020,0x60FF0020,0x00000008}}, /*TOBJ1601*/
{2, {0x60400010,0x60FF0020}}, /*TOBJ1602*/
/*ECATCHANGE_START(V5.11) CiA402 1*/
{5, {0x60410010,0x60640020,0x606C0020,0x60610008,0x00000008}}, /*TOBJ1A00*/
/*ECATCHANGE_END(V5.11) CiA402 1*/
{6, {0x60410010,0x60640020,0x60770020,0x606C0020,0x60610008,0x00000008}}, /*TOBJ1A01*/
...
0x0,/*(INT32) Target Torque    0x608A*/
0x0,/*(INT32) Target Kp    0x6096*/
0x0,/*(INT32) Target Kd    0x6098*/
...
/*ECATCHANGE_END(V5.11) CiA402 1*/
    /* Object 0x1601 */
   {NULL,NULL, 0x1601, {DEFTYPE_PDOMAPPING, 8 | (OBJCODE_REC << 8)}, asEntryDesc0x1601, aName0x1601,NULL, NULL, NULL, 0x0000 },
    /* Object 0x1602 */
...
/*ECATCHANGE_END(V5.11) CiA402 1*/
   /* Object 0x1A01 */
   {NULL,NULL, 0x1A01, {DEFTYPE_PDOMAPPING, 6 | (OBJCODE_REC << 8)}, asEntryDesc0x1A01, aName0x1A01, NULL, NULL, NULL, 0x0000 },	
   /* Object 0x1A02 */
   ...
   /* Object 0x6077 */
   {NULL,NULL, 0x6077, {DEFTYPE_INTEGER32 , 0 | (OBJCODE_VAR << 8)}, &sEntryDesc0x6077, aName0x6077, NULL, NULL, NULL, 0x0000 },
   /* Object 0x607D */
   ...
   {NULL,NULL, 0x6085, {DEFTYPE_UNSIGNED32 , 0 | (OBJCODE_VAR << 8)}, &sEntryDesc0x6085, aName0x6085, NULL, NULL, NULL, 0x0000 },
    /* Object 0x608A */
   {NULL,NULL, 0x608A, {DEFTYPE_INTEGER32 , 0 | (OBJCODE_VAR << 8)}, &sEntryDesc0x608A, aName0x608A, NULL, NULL, NULL, 0x0000 },
   
   {NULL,NULL, 0x6096, {DEFTYPE_INTEGER32 , 0 | (OBJCODE_VAR << 8)}, &sEntryDesc0x6096, aName0x6096, NULL, NULL, NULL, 0x0000 },
   {NULL,NULL, 0x6098, {DEFTYPE_INTEGER32 , 0 | (OBJCODE_VAR << 8)}, &sEntryDesc0x6098, aName0x6098, NULL, NULL, NULL, 0x0000 },
