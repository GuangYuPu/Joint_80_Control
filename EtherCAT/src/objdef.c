...
UINT8 CheckSyncTypeValue(UINT16 index, UINT16 NewSyncType)
{
    ...
    case SYNCTYPE_DCSYNC0:
        ...
        else if ((index == 0x1C33) && ((sSyncManInPar.u16SyncTypesSupported & SYNCTYPE_DCSYNC0SUPP) > 0))
        {
            return 0;
        }
        break;
    ...
    case SYNCTYPE_DCSYNC1:
        ...
        else if ((index == 0x1C33) && ((sSyncManInPar.u16SyncTypesSupported & SYNCTYPE_DCSYNC1SUPP) > 0))
        {
            return 0;
        }
        break;
