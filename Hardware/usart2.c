...
#include "tamagawa.h"
/********************************************************************/
uint8_t snd2_buff[USART2_BUFFER_SIZE];
uint8_t rcv2_buff[USART2_BUFFER_SIZE];
...
{
    while((USART_STAT0(USART2)&0x40)==0);
    USART_DATA(USART2) = (u8) ch;
    return ch;
}
#endif
/********************************************************************/
...
//    NVIC_Init(&NVIC_InitStructure);
    ...
    USART_DMACmd(USART3,USART_DMAReq_Rx,ENABLE);   //DMA收
//		USART_DMACmd(USART3,USART_DMAReq_Tx,ENABLE);   //DMA收
...
//    DMA_InitStructure.DMA_Memory0BaseAddr = (u32)&TXData;
...
//    DMA_Cmd(DMA1_Stream3,DISABLE);
    ...
    DMA_InitStructure.DMA_Channel = DMA_Channel_4;
    DMA_InitStructure.DMA_PeripheralBaseAddr = (u32)&USART3->DR;
    DMA_InitStructure.DMA_Memory0BaseAddr = (u32)&usart_data;
